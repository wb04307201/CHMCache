 ...
 */
public final class HotKeySampler<K> {
     ...
     */
    public long estimateCount(K key) {
        int h1 = spread(key == null ? 0 : key.hashCode());
     ...
     */
    public List<K> topHotKeys(List<K> candidates, int n) {
        List<K> sorted = new ArrayList<>(candidates);
